...
assert.match(dashboardSource, /rounded-md border border-zinc-200 bg-white px-3 py-1\.5 text-xs leading-5 text-zinc-500/);
...
assert.match(dashboardSource, /inset-\[27%\]/);
