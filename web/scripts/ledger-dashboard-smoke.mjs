...
assert.match(dashboardSource, /void loadLedgerDashboard\(session\.accessToken, draftAsAtDate, draftCompareAsAtDate, dashboardWindowDays\(draftAsAtDate, draftCompareAsAtDate\), \{ applyDates: true \}\)/);
