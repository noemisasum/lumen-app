...
assert.match(dashboardSource, /Donut chart of USD liquidity across Own Funds, Client Funds, MP, and LP\./);
assert.match(dashboardSource, /Total USD exposure; external float is/);
assert.match(dashboardSource, /Data last updated:/);
assert.match(dashboardSource, /inset-\[24%\]/);
assert.match(dashboardSource, /money_processor: "MP"/);
assert.match(dashboardSource, /liquidity_provider: "LP"/);
assert.match(dashboardSource, /operating_bank: "#0f766e"/);
assert.match(dashboardSource, /client_money: "#65a30d"/);
assert.match(dashboardSource, /money_processor: "#b45309"/);
assert.match(dashboardSource, /liquidity_provider: "#4f46e5"/);
...
assert.match(dashboardSource, /const externalFloatExposure = absoluteMixTotal/);
