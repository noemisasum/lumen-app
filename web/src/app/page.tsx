        ...
        <main className="grid flex-1 items-center gap-8 py-8 sm:py-10 lg:grid-cols-[minmax(0,1fr)_430px] lg:gap-12">
          <section className="min-w-0 max-w-2xl">
            ...
            <div className="mt-7 grid grid-cols-1 gap-3 min-[520px]:grid-cols-2 sm:mt-8 sm:flex sm:items-center">
              ...
              <Link
                href="/login"
                className="inline-flex h-11 items-center justify-center rounded-lg border border-zinc-300 bg-white px-4 text-sm font-medium text-zinc-900 shadow-sm transition hover:border-zinc-400 hover:bg-zinc-50 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-zinc-950 sm:px-5"
              >
                Sign In
              </Link>
            </div>
